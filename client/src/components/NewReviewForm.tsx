...
export default function NewReviewForm() {
  ...
  return (
    <div className="flex h-full w-full justify-center bg-gray-200 dark:bg-gray-800">
      <div className='flex h-5/6 justify-center'>
      <div className="flex justify-center self-center p-6 bg-white dark:bg-gray-900 rounded-xl">
            ...
            {Object.entries(selectInputs).map(([selectInput, inputOptions]) => (
              <label key={selectInput}>
                ...
                {errors[selectInput as keyof IReview] && (
                  <div className="text-red-700">Please select {selectInput}</div>
                )}
              </label>
            ))}
